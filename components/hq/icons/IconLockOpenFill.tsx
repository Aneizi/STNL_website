...
/** Open padlock: a Captains-only surface this account may open. Inherits color from its parent. */
export function IconLockOpenFill({
  width = 21,
  height = 20,
  ...props
