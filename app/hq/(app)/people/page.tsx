...
import { getHackathon, getPeople, getRoles } from "@/lib/hq/queries";
...
export default async function PeoplePage(props: {
  ...
  const [, hackathon, people, roles] = await Promise.all([
    requireUser(),
  ...
  return <People people={people} roles={roles} reset={Boolean(reset)} />;
}
